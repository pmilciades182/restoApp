                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @foreach ($categories as $category)
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="text-sm text-gray-900 line-clamp-2">{{ $category->description }}
                                        </div>
                                    </td>
                                    <!-- Columna de acciones modernizada -->
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <div class="flex items-center gap-2">
                                            ...
                                            <button
                                                ...
                                                message: '¿Estás seguro que deseas eliminar esta categoría? Si la categoría tiene productos asociados, deberás reasignarlos o eliminarlos primero.',
                                                callback: (confirmed) => {
                                                    if (confirmed) {
                                                ...
                                                <span
                                                    class="ml-2 text-gray-700 group-hover:text-white transition-colors duration-200">Eliminar</span>
                                            </button>
