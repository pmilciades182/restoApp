<!-- resources/views/livewire/document-type-table.blade.php -->
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @foreach ($documentTypes as $documentType)
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        @if ($documentType->requires_verification_digit)
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <div class="flex items-center gap-2">
                                            <!-- Botón Editar -->
                                            <button wire:click="edit({{ $documentType->id }})"
                                            ...
                                            <button x-on:click="$dispatch('open-confirm-modal', {
                                                message: '¿Estás seguro que deseas eliminar este tipo de documento? Si hay documentos asociados a clientes, no podrá ser eliminado.',
                                                callback: (confirmed) => {
                                                    if (confirmed) {
